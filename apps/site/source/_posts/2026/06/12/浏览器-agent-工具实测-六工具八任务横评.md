...
<div class="dv-head"><span class="dv-kick">维度 ② 稳定性</span><div class="dv-title">可靠性（实测加权 · 跨最多 4 轮）</div><div class="dv-sub">每轮信用 <b>✅成功=1.0 / ⚠️部分=0.4 / N-R 没跑成·可修=0.7</b>（attach 崩、环境失败轻扣）<b> / ❌ 硬失败=0</b>（缺陷重扣）。口径借鉴 τ-bench pass^k + 缺陷严重度加权。逐任务明细见下图；<b>分接近时再看括注的"硬伤性质"</b>。</div></div>
<div class="dv-row"><div class="dv-name">agent-browser</div><div class="dv-bar"><span class="dv-fill f-best" style="width:95%">95</span></div></div>
<div class="dv-row"><div class="dv-name">playwright-cli</div><div class="dv-bar"><span class="dv-fill f-best" style="width:93%">93</span></div></div>
<div class="dv-row"><div class="dv-name">DevTools MCP</div><div class="dv-bar"><span class="dv-fill f-best" style="width:93%">93</span></div></div>
<div class="dv-row"><div class="dv-name">bb-browser</div><div class="dv-bar"><span class="dv-fill f-mid" style="width:75%">75</span></div></div>
<div class="dv-foot">三家（agent-browser / playwright / DevTools）<b>实测稳定性接近 93–95</b>，真正的差异在<b>硬伤性质</b>：DevTools <b>零静默失败、最可控</b>；agent-browser 95 分但有<b>静默空点 + daemon 粘滞</b>（实测多被 eval 兜回、没致失败，但对自主 Agent 是隐患）；playwright 的 attach 崩<b>响而可修</b>（塞 about:blank）；bb-browser 75 因 <b>click 注入 bug</b> 多题硬失败。"静默失败比响亮崩溃更坑"（§5）——所以质性可控度上 DevTools &gt; playwright &gt; agent-browser。</div>
</figure>

<figure class="stabd" role="group" aria-label="逐任务稳定性详细图：4 个 CDP 工具 × 31 任务，严重度加权可靠性分（最多 4 轮）">
<style>
.stabd{--paper-soft:#faf6ec;--paper-deep:#ece5d5;--paper-vsoft:#f7f1e4;--ink:#1a1815;--ink-soft:#3c362c;--muted:#6a6155;--hair:rgba(26,24,21,.18);--serif:var(--font-serif-body,"Songti SC","Source Han Serif SC",Georgia,serif);--mono:var(--font-mono,ui-monospace,"SFMono-Regular",monospace);--cyan:#3f6d79;margin:1.6rem 0;padding:clamp(14px,3vw,22px);font-family:var(--serif);color:var(--ink);line-height:1.45;background:radial-gradient(130% 90% at 90% 0%,var(--paper-soft),transparent 60%),linear-gradient(160deg,var(--paper-vsoft),var(--paper-deep));border:1px solid var(--hair);border-radius:14px}
.stabd *{box-sizing:border-box;min-width:0}
.stabd .sd-kick{font-family:var(--mono);font-size:10.5px;letter-spacing:.2em;text-transform:uppercase;color:var(--cyan);display:inline-flex;align-items:center;gap:8px}.stabd .sd-kick::before{content:"";width:20px;height:1px;background:var(--cyan)}
.stabd .sd-title{font-size:clamp(14px,2.8vw,18px);font-weight:700;margin:6px 0 3px}.stabd .sd-sub{font-size:12px;color:var(--muted);max-width:70ch;margin-bottom:12px}.stabd .sd-sub b{color:var(--ink-soft)}
.stabd .sd-scroll{overflow-x:auto;-webkit-overflow-scrolling:touch;border-radius:10px;border:1px solid var(--hair)}
.stabd table{border-collapse:collapse;width:100%;min-width:560px;background:color-mix(in srgb,var(--paper-soft) 55%,transparent)}
.stabd th,.stabd td{border:1px solid var(--hair);padding:5px 7px;text-align:center;font-size:11.5px}
.stabd thead th{font-family:var(--mono);font-size:11px;color:var(--ink-soft);background:color-mix(in srgb,var(--paper-soft) 80%,transparent);white-space:nowrap;position:sticky;top:0}
.stabd td.tk{text-align:left;font-family:var(--mono);font-size:11px;color:var(--ink);white-space:nowrap}.stabd td.tk small{color:var(--muted);font-weight:400}
.stabd td.sc{font-family:var(--mono);font-weight:700;color:#1a1815}.stabd td.sc small{display:block;font-weight:400;font-size:8.5px;color:#3c362c;opacity:.7;letter-spacing:1px}
.stabd .s-a{background:#cfe0bd}.stabd .s-b{background:#e7eedd}.stabd .s-c{background:#f4e8cc}.stabd .s-d{background:#eed7b0}.stabd .s-e{background:#f1ddd6}.stabd .s-na{background:#ece4d2;color:#917f5c}
.stabd .sd-avg{display:flex;flex-wrap:wrap;gap:8px;margin-top:12px}.stabd .sd-av{font-family:var(--mono);font-size:12px;border:1.5px solid var(--hair);border-radius:8px;padding:4px 10px;background:var(--paper-soft)}.stabd .sd-av b{font-size:15px}
.stabd .sd-foot{margin-top:11px;border-top:1px dashed var(--hair);padding-top:9px;font-family:var(--mono);font-size:10px;color:var(--muted);line-height:1.6}.stabd .sd-foot a{color:var(--cyan)}
</style>
<div class="sd-kick">维度 ② 稳定性 · 逐任务</div><div class="sd-title">逐任务可靠性（严重度加权，跨最多 4 轮）</div>
<div class="sd-sub">每格＝该任务跨轮的<b>加权可靠性分</b>。每轮信用：<b>✅/✅*成功=1.0</b>、<b>⚠️部分=0.4</b>、<b>N-R 没跑成/可修=0.7</b>（如 playwright attach 崩、站点环境失败——轻扣）、<b>❌ 硬失败=0.0</b>（如 bb 的 click 注入 bug——重扣）。小字＝各轮判定。降级在「能力图」已计、此处不重复扣。</div>
<div class="sd-scroll"><table><thead><tr><th style="text-align:left">任务</th><th>agent-browser</th><th>playwright</th><th>DevTools MCP</th><th>bb-browser</th></tr></thead><tbody>
<tr><td class="tk">T01 <small>登录观察</small></td><td class="sc s-a">100<small>✅✅✅✅</small></td><td class="sc s-a">100<small>✅✅✅✅</small></td><td class="sc s-a">100<small>✅✅✅</small></td><td class="sc s-d">40<small>⚠️⚠️</small></td></tr>
<tr><td class="tk">T02 <small>Network 排障</small></td><td class="sc s-a">100<small>✅✅✅✅</small></td><td class="sc s-a">100<small>✅✅✅✅</small></td><td class="sc s-a">100<small>✅✅✅</small></td><td class="sc s-a">100<small>✅✅</small></td></tr>
<tr><td class="tk">T03 <small>性能诊断</small></td><td class="sc s-a">100<small>✅✅✅✅</small></td><td class="sc s-a">100<small>✅✅✅✅</small></td><td class="sc s-a">100<small>✅✅✅</small></td><td class="sc s-a">100<small>✅✅</small></td></tr>
<tr><td class="tk">T04 <small>请求 mock</small></td><td class="sc s-a">100<small>✅✅✅✅</small></td><td class="sc s-a">100<small>✅✅✅✅</small></td><td class="sc s-a">100<small>✅✅✅</small></td><td class="sc s-e">0<small>❌❌</small></td></tr>
<tr><td class="tk">T05 <small>动态等待</small></td><td class="sc s-a">100<small>✅✅✅✅</small></td><td class="sc s-a">100<small>✅✅✅✅</small></td><td class="sc s-a">100<small>✅✅✅</small></td><td class="sc s-a">100<small>✅✅</small></td></tr>
<tr><td class="tk">T06 <small>结构化提取</small></td><td class="sc s-a">100<small>✅✅✅✅</small></td><td class="sc s-a">100<small>✅✅✅✅</small></td><td class="sc s-a">100<small>✅✅✅</small></td><td class="sc s-a">100<small>✅✅</small></td></tr>
<tr><td class="tk">T07 <small>已登录 fetch</small></td><td class="sc s-a">100<small>✅✅✅✅</small></td><td class="sc s-a">100<small>✅✅✅✅</small></td><td class="sc s-a">100<small>✅✅✅</small></td><td class="sc s-a">100<small>✅✅</small></td></tr>
<tr><td class="tk">T08 <small>Shadow DOM</small></td><td class="sc s-b">85<small>⚠️✅✅✅</small></td><td class="sc s-a">100<small>✅✅✅✅</small></td><td class="sc s-a">100<small>✅✅✅</small></td><td class="sc s-a">100<small>✅✅</small></td></tr>
<tr><td class="tk">T09 <small>扩展 reload</small></td><td class="sc s-a">100<small>✅✅✅✅</small></td><td class="sc s-b">85<small>✅✅✅⚠️</small></td><td class="sc s-a">100<small>✅✅✅</small></td><td class="sc s-e">0<small>❌❌</small></td></tr>
<tr><td class="tk">T10a <small>真实登录态</small></td><td class="sc s-b">85<small>⚠️✅✅✅</small></td><td class="sc s-b">85<small>✅✅N-RN-R</small></td><td class="sc s-a">100<small>✅</small></td><td class="sc s-na">N/A</td></tr>
<tr><td class="tk">T10b <small>登录态持久化</small></td><td class="sc s-c">70<small>⚠️✅</small></td><td class="sc s-b">85<small>✅N-R</small></td><td class="sc s-a">100<small>✅</small></td><td class="sc s-na">N/A</td></tr>
<tr><td class="tk">T10c <small>指定 9223</small></td><td class="sc s-a">100<small>✅✅</small></td><td class="sc s-a">100<small>✅✅</small></td><td class="sc s-a">100<small>✅✅</small></td><td class="sc s-a">100<small>✅✅</small></td></tr>
<tr><td class="tk">T11 <small>用扩展改徽标</small></td><td class="sc s-a">100<small>✅✅✅✅</small></td><td class="sc s-a">100<small>✅✅✅</small></td><td class="sc s-a">100<small>✅✅✅✅</small></td><td class="sc s-e">33<small>❌✅❌</small></td></tr>
<tr><td class="tk">T12 <small>Console/SourceMap</small></td><td class="sc s-a">100<small>✅✅✅✅</small></td><td class="sc s-a">100<small>✅✅✅</small></td><td class="sc s-a">100<small>✅✅✅✅</small></td><td class="sc s-a">100<small>✅✅✅</small></td></tr>
<tr><td class="tk">T13 <small>移动端遮挡</small></td><td class="sc s-a">100<small>✅✅✅✅</small></td><td class="sc s-a">100<small>✅✅✅</small></td><td class="sc s-a">100<small>✅✅✅✅</small></td><td class="sc s-d">47<small>❌⚠️✅</small></td></tr>
<tr><td class="tk">T14 <small>Hydration</small></td><td class="sc s-a">100<small>✅✅✅✅</small></td><td class="sc s-a">100<small>✅✅✅</small></td><td class="sc s-a">100<small>✅✅✅✅</small></td><td class="sc s-a">100<small>✅✅✅</small></td></tr>
<tr><td class="tk">T15 <small>SSE 流</small></td><td class="sc s-c">75<small>✅✅❌✅</small></td><td class="sc s-a">100<small>✅✅✅</small></td><td class="sc s-c">75<small>✅✅❌✅</small></td><td class="sc s-b">90<small>✅✅N-R</small></td></tr>
<tr><td class="tk">T16 <small>SW 缓存</small></td><td class="sc s-b">85<small>✅✅⚠️✅</small></td><td class="sc s-a">100<small>✅✅✅</small></td><td class="sc s-b">85<small>✅✅⚠️✅</small></td><td class="sc s-b">80<small>✅✅⚠️</small></td></tr>
<tr><td class="tk">T17 <small>跨域 iframe</small></td><td class="sc s-c">75<small>✅✅❌✅</small></td><td class="sc s-a">100<small>✅✅✅</small></td><td class="sc s-c">75<small>✅✅❌✅</small></td><td class="sc s-e">23<small>❌❌N-R</small></td></tr>
<tr><td class="tk">T18 <small>文件上传</small></td><td class="sc s-a">100<small>✅✅✅✅</small></td><td class="sc s-a">100<small>✅✅✅</small></td><td class="sc s-b">85<small>⚠️✅✅✅</small></td><td class="sc s-d">47<small>❌⚠️✅</small></td></tr>
<tr><td class="tk">T19 <small>键盘可访问</small></td><td class="sc s-a">100<small>✅✅✅✅</small></td><td class="sc s-a">100<small>✅✅✅</small></td><td class="sc s-a">100<small>✅✅✅✅</small></td><td class="sc s-a">100<small>✅✅✅</small></td></tr>
<tr><td class="tk">T20 <small>Flake 率</small></td><td class="sc s-c">75<small>✅✅❌✅</small></td><td class="sc s-a">100<small>✅✅✅</small></td><td class="sc s-c">75<small>✅✅❌✅</small></td><td class="sc s-b">90<small>✅✅N-R</small></td></tr>
<tr><td class="tk">R01 <small>GitHub 代码导航</small></td><td class="sc s-a">100<small>✅✅</small></td><td class="sc s-b">85<small>✅✅N-RN-R</small></td><td class="sc s-a">100<small>✅✅</small></td><td class="sc s-a">100<small>✅✅✅</small></td></tr>
<tr><td class="tk">R02 <small>GitHub 登录态</small></td><td class="sc s-a">100<small>✅✅</small></td><td class="sc s-b">85<small>✅✅N-RN-R</small></td><td class="sc s-a">100<small>✅✅</small></td><td class="sc s-a">100<small>✅✅✅</small></td></tr>
<tr><td class="tk">R03 <small>MDN 阅读</small></td><td class="sc s-a">100<small>✅✅</small></td><td class="sc s-b">85<small>✅✅N-RN-R</small></td><td class="sc s-a">100<small>✅✅</small></td><td class="sc s-a">100<small>✅✅✅</small></td></tr>
<tr><td class="tk">R04 <small>npm 元数据</small></td><td class="sc s-a">100<small>✅✅</small></td><td class="sc s-b">85<small>✅✅N-RN-R</small></td><td class="sc s-a">100<small>✅✅</small></td><td class="sc s-a">100<small>✅✅✅</small></td></tr>
<tr><td class="tk">R05 <small>Web Store</small></td><td class="sc s-a">100<small>✅✅</small></td><td class="sc s-b">85<small>✅✅N-RN-R</small></td><td class="sc s-a">100<small>✅✅</small></td><td class="sc s-a">100<small>✅✅✅</small></td></tr>
<tr><td class="tk">R06 <small>扩展注入真实站</small></td><td class="sc s-a">100<small>✅✅</small></td><td class="sc s-c">60<small>✅❌N-RN-R</small></td><td class="sc s-d">50<small>✅❌</small></td><td class="sc s-e">0<small>❌❌❌</small></td></tr>
<tr><td class="tk">R07 <small>真实 Network 体</small></td><td class="sc s-a">100<small>✅✅</small></td><td class="sc s-b">85<small>✅✅N-RN-R</small></td><td class="sc s-a">100<small>✅✅</small></td><td class="sc s-b">80<small>✅⚠️✅</small></td></tr>
<tr><td class="tk">R08 <small>真实站请求拦截</small></td><td class="sc s-a">100<small>✅✅</small></td><td class="sc s-b">85<small>✅✅N-RN-R</small></td><td class="sc s-c">70<small>N-RN-R</small></td><td class="sc s-c">70<small>N-RN-RN-R</small></td></tr>
<tr><td class="tk">R09 <small>真实站 HAR/性能</small></td><td class="sc s-a">100<small>✅✅</small></td><td class="sc s-c">70<small>✅⚠️N-RN-R</small></td><td class="sc s-c">70<small>✅⚠️</small></td><td class="sc s-c">67<small>✅❌✅</small></td></tr>
</tbody></table></div>
<div class="sd-avg"><span class="sd-av">agent-browser <b>95</b></span><span class="sd-av">playwright <b>93</b></span><span class="sd-av">DevTools MCP <b>93</b></span><span class="sd-av">bb-browser <b>75</b></span></div>
<div class="sd-foot">加权平均稳定性：agent-browser 95 ≈ playwright 93 ≈ DevTools MCP 93（三家接近），bb-browser 75（click-bug 拖累）。轮次来源：Codex 2 轮（unified+rerun2）+ Claude 复跑 2 轮（靶场/外场）；个别格仅 2 轮。口径借鉴 τ-bench pass^k（多轮一致性）+ 缺陷严重度加权（DSI 思路）。注：速度/token 当初只按整轮总数测、<b>无逐任务埋点</b>，故只有此稳定性能逐任务拆。</div>
</figure>
...
<div class="dv-row" style="grid-template-columns:clamp(94px,20%,140px) repeat(5,1fr);gap:6px"><div class="dv-name" style="color:var(--pur)">playwright-cli</div><div class="dv-bar"><span class="dv-fill" style="width:97%;background:var(--pur)">97</span></div><div class="dv-bar"><span class="dv-fill" style="width:93%;background:var(--pur)">93</span></div><div class="dv-bar"><span class="dv-fill" style="width:97%;background:var(--pur)">97</span></div><div class="dv-bar"><span class="dv-fill" style="width:95%;background:var(--pur)">95</span></div><div class="dv-bar"><span class="dv-fill f-best" style="width:95%">95</span></div></div>
<div class="dv-row" style="grid-template-columns:clamp(94px,20%,140px) repeat(5,1fr);gap:6px"><div class="dv-name" style="color:var(--cyan)">agent-browser</div><div class="dv-bar"><span class="dv-fill" style="width:77%;background:var(--cyan)">77</span></div><div class="dv-bar"><span class="dv-fill" style="width:95%;background:var(--cyan)">95</span></div><div class="dv-bar"><span class="dv-fill" style="width:94%;background:var(--cyan)">94</span></div><div class="dv-bar"><span class="dv-fill" style="width:100%;background:var(--cyan)">100</span></div><div class="dv-bar"><span class="dv-fill f-mid" style="width:92%">92</span></div></div>
<div class="dv-row" style="grid-template-columns:clamp(94px,20%,140px) repeat(5,1fr);gap:6px"><div class="dv-name" style="color:var(--grn)">DevTools MCP</div><div class="dv-bar"><span class="dv-fill" style="width:90%;background:var(--grn)">90</span></div><div class="dv-bar"><span class="dv-fill" style="width:93%;background:var(--grn)">93</span></div><div class="dv-bar"><span class="dv-fill" style="width:100%;background:var(--grn)">100</span></div><div class="dv-bar"><span class="dv-fill" style="width:20%;background:var(--grn)">20</span></div><div class="dv-bar"><span class="dv-fill f-mid" style="width:76%">76</span></div></div>
<div class="dv-row" style="grid-template-columns:clamp(94px,20%,140px) repeat(5,1fr);gap:6px"><div class="dv-name" style="color:var(--gray)">bb-browser</div><div class="dv-bar"><span class="dv-fill" style="width:26%;background:var(--gray)">26</span></div><div class="dv-bar"><span class="dv-fill" style="width:75%;background:var(--gray)">75</span></div><div class="dv-bar"><span class="dv-fill" style="width:20%;background:var(--gray)">20</span></div><div class="dv-bar"><span class="dv-fill" style="width:65%;background:var(--gray)">65</span></div><div class="dv-bar"><span class="dv-fill f-worst" style="width:47%">47</span></div></div>
<div class="dv-foot">归一口径：能力＝原生/31；稳定＝实测加权可靠性分（见上面逐任务图）；速度/token＝同宿主倒数归一。等权综合：playwright 95 ＞ agent-browser 92 ＞ DevTools 76 ＞ bb 47——**四维等权下 playwright 与 agent-browser 贴得很近（稳定性三家本就接近）；DevTools 被 token 拖累，bb 全面落后**。权重不同结论会变（如你重原生能力则 playwright，重 token 则 agent-browser），所以最终回到"没有银弹、按风格选"。</div>
</figure>
...
四维一摊开就清楚了——**能力（原生）playwright 最强、token agent-browser 最省、稳定性三家接近（实测加权 agent 95 / pw 93 / DevTools 93，质性上 DevTools 最可控）、速度三家平手**，没有一个工具四项全赢。等权归一综合是 **playwright 居首（92）**；agent-browser（83）主要赢在 token（且只省 ~4%）和"能可预测地 attach 一个固定的真实登录态 9223"（playwright 的 attach 看浏览器状态）。所以"只装一款"取决于你最看重哪一维：
